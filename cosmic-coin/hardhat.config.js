...
// Keeps `npx hardhat compile` working behind restrictive proxies.
...
module.exports = {
  ...
  networks: {
    hardhat: {},
    // Robinhood Chain public testnet (Arbitrum Orbit). Chain ID 46630.
    robinhoodTestnet: {
      url: process.env.ROBINHOOD_TESTNET_RPC || "https://rpc.testnet.chain.robinhood.com",
      chainId: 46630,
      accounts: PRIVATE_KEY,
    },
    // Robinhood Chain mainnet (Arbitrum Orbit). Chain ID 4663.
    robinhoodMainnet: {
